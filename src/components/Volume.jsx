...
export default function Volume ({ powerOff, volume, handleVolumeChange }) {
    return (
        <label className="slider">
  <input type="range" className="level" disabled={powerOff} onChange={handleVolumeChange} value={volume} id="volume"  />
  <svg
    className="volume"
